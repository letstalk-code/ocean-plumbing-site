        ...
        return (
            <main style={{
                ...
                <div style={{ maxWidth: '600px', width: '100%', textAlign: 'center' }}>
                    ...
                    <h1 style={{ fontSize: '3rem', color: '#0076BD' }}>Sounds good — <span style={{ color: '#9C1F2E' }}>I’ll take it from here.</span></h1>
        ...
        <main style={{
            ...
            <div style={{ maxWidth: '600px', width: '100%', textAlign: 'center' }}>
                ...
                <h1 style={{
                    ...
                    Sounds good — I’ll <span style={{ color: '#9C1F2E' }}>take it from here.</span>
                </h1>
                ...
                <form onSubmit={handleSubmit} style={{
                    ...
                    <div style={{ marginBottom: '40px' }}>
                        ...
                        <input required type="text" placeholder="Ocean Plumbing" style={{ width: '100%', padding: '15px', borderRadius: '12px', border: '1px solid #cbd5e1', fontSize: '1rem' }} />
                    </div>

                    <button type="submit" disabled={isSubmitting} style={{
                        width: '100%',
                        backgroundColor: isSubmitting ? '#cbd5e1' : '#0076BD',
                        color: '#fff',
                        padding: '20px',
                        borderRadius: '16px',
                        border: 'none',
                        ...
                        boxShadow: isSubmitting ? 'none' : `0 10px 20px rgba(0, 118, 189, 0.2)`
                    }}>
